...
HD_PWD='C:/Users/bdionello/source/ECE449/project_cpu/project_cpu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myNANDgate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myNANDgate.tcl
