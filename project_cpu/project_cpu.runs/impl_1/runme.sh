...
HD_PWD='C:/Users/bdionello/source/ECE449/project_cpu/project_cpu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myNANDgate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source myNANDgate.tcl -notrace
