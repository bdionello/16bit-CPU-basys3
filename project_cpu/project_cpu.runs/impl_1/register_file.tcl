...
set rc [catch {
  ...
  add_files -quiet C:/Users/bdionello/source/ECE449/project_cpu/project_cpu.runs/synth_1/register_file.dcp
  link_design -top register_file -part xc7a35tcpg236-1
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file register_file_timing_summary_routed.rpt -rpx register_file_timing_summary_routed.rpx -warn_on_violation "
