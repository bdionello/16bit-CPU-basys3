...
set_property PACKAGE_PIN W5 [get_ports board_clock]
      ...
      create_clock -add -name board_clock -period 10.00 -waveform {0 5} [get_ports board_clock]
...
create_clock -add -name stm_sys_clk -period 22.00 -waveform {0 11} [get_ports stm_sys_clk]
#create_clock -period 28.300 -name stm_sys_clk -waveform {0.000 19.000} [get_ports stm_sys_clk]
